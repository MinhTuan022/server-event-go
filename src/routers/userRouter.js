...
const {getAllUser, getUserById, handleFollow, checkFollowingStatus, getFollowers, getFavorites, handleFavorite, updateProfile, checkFriend, checkRelationship, getFriend} = require("../controllers/userControllers")
